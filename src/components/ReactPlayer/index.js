...
export default class ReactPlayer extends Component {
  ...
  getUrl = () => this.props.dash_url || this.props.hls_url || this.props.wistia_url || this.props.url
  shouldComponentUpdate (nextProps) {
    const url = this.getUrl()
    const nextUrl = nextProps.dash_url || nextProps.hls_url || nextProps.wistia_url || nextProps.url
    return (
      url !== nextUrl ||
