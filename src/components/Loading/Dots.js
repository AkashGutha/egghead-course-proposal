...
const Dots = () => (
  <div className='flex justify-center items-center h5 w-100'>
    <svg width="57px"  height="57px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" className="lds-ellipsis" style={{background: 'none'}}>
