...
const toggleOptions = ['Github', 'Plunker']
      ...
      <div className={`bg-white br2 flex-grow-1 ${sharedCss.box}`}>
        ...
        {this.state.selected === PLUNKER ? (
          <CodeInput
            ...
            placeholder="Enter your Plunker URL. Example: https://embed.plnkr.co/8XHq7g/"
            onChange={value => {
          ...
          <div>
            <CodeInput
              ...
              onChange={value => set(lesson, 'code.github.user', value)}
              hint="This hint can be modified in the LessonEdits/components/forms/Code render function"
            />
            <CodeInput
              label="GITHUB REPOSITORY NAME"
              value={get(lesson, 'code.github.repo')}
              onChange={value => set(lesson, 'code.github.repo', value)}
              hint="This hint can be modified in the LessonEdits/components/forms/Code render function"
            />
            <CodeInput
              label="GITHUB BRANCH/TAG"
              value={get(lesson, 'code.github.branch')}
              onChange={value => set(lesson, 'code.github.branch', value)}
              hint="This hint can be modified in the LessonEdits/components/forms/Code render function"
            />
          </div>
        )}
