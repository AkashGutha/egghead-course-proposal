...
import {pull, get, toString, some} from 'lodash'

@observer class TagButton extends React.Component {
  ...
  componentWillReceiveProps(nextProps){
    nextProps.item.id !== this.props.item.id && this.setActiveByItem(nextProps.item)
  }
  ...
  render(){
    ...
    return(
      <div
        ...
        className={`flex flex-row ma1 pa2 br2 ba pointer ${this.active ? activeClasses : inactiveClasses} ${this.hover && hoverClasses}`}
      >
        {image &&
          <div className="mr2">
