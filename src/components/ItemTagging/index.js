...
class ItemTagging extends React.Component {
  ...
  inCourseContext = () => {return !this.props.item.lesson_url;}
  ...
  lessonsUntagged = () => {
    ...
    forEach(lessons, (lesson) => {
      const {language_list, framework_list, skillset_list, library_list, tool_list, platform_list} = lesson
      result = isEmpty(flatten(language_list, framework_list, skillset_list, library_list, tool_list, platform_list))
    })
