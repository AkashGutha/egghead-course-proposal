...
class DurationFavorited extends React.Component {
  ...
  render() {
    const classes = 'w-100 pa1 tl mv0 flex flex-row items-center no-underline dark-gray';
    if (this.props.hover && this.props.currentUser) {
      return (
        <div className={cn(classes, 'pointer')}
      ...
      return (
        <div className={classes}>
          ...
          <div className={`dark-gray sans-serif ${css.timeDuration} ${this.props.completed ? 'base' : 'dark-gray'}`}>
